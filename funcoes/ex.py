...
# def percentualSotckout(dicionario_vendas):
#     vendaperdidas = 0
#     vendasconcluida = 0
#     for item in dicionario_vendas:
#         valor,status,motivo = dicionario_vendas[item]

#         if status == 'Concluido':
#             vendasconcluida += valor
#         elif motivo == 'Estoque em Falta':
#             vendaperdidas += valor
#             vendasconcluida += valor

#     return vendasconcluida / vendaperdidas
...
# # print(percentualSotckout(vendas))
...
# def ClientesInadimpletes(clientes):
#     inadimplentes = []
#     for item in clientes:
#         cpf,divida,dias = item
#         if dias > 20 and divida > 1000:
#             inadimplentes.append(cpf)
#     return inadimplentes



# print(ClientesInadimpletes(clientes_devedores))
# print(len(ClientesInadimpletes(clientes_devedores)))
...
#     perce =  len(listavendedores) /len(vendas) 

#     return (listavendedores,perce)


# print(Calcularmeta(meta,vendas))
...
# print(precos_teste)
#
# def separar_listas(precos,tamanhos,fator):
...
#         return
#
# print(separar_listas(precos_imoveis,tamanho_imoveis,fator))
...
def listaproduto(*produtos):
    ...
    listaproduto = set(listaproduto)
    listaproduto = list(listaproduto)
    print(len(listaproduto))
    return listaproduto

print(listaproduto(estoque_fim_abr,estoque_fim_mar,estoque_fim_fev,estoque_fim_jan))